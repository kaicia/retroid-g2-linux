...
# --- Forbidden: SM7635/Milos per-NoC topology and SM8550/SM8650 values ---
forbidden = {
...
# The Cliffs header must not carry the Milos per-NoC IDs 8/20/1 for the
# SDCC2/EBI1 endpoints.
check("MASTER_SDCC_2" not in header or "MASTER_SDCC_2\t\t\t8" not in header,
